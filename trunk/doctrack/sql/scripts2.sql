...
INSERT INTO `roles` VALUES (1,'Administrador','Si','Si','Si','Si','Si','Si','Si'),(2,'(INACTIVO) chiqui','Si','Si','Si','Si','Si','Si','Si');
...
INSERT INTO `superviciones` VALUES (1,'1','Carlos A. López','(0000) 000-000','sinemail',1,2),(2,'2','Encarnación','(0000) 000-000','sup2@gmail.co1',1,1);
...
INSERT INTO `seguimiento` VALUES (1,'2018-06-03 23:05:26','2018-06-03 23:05:26','Concluido','probar Documento',1,'No'),(2,'2018-06-03 23:10:24','2018-06-05 11:28:19','Concluido','segundo documento',2,'Si'),(3,'2018-06-05 13:42:51','2018-06-05 14:47:44','Concluido','con nuevo campo',5,'Si'),(4,'2018-06-05 14:07:19','2018-06-05 14:07:19','Recibido','conseguimiento',6,'No'),(5,'2018-06-05 14:39:43','2018-06-05 14:39:43','Recibido','probar seguimiento',7,'No');
...
CREATE TABLE `respuesta` (
  ...
  KEY `idFuncionario` (`idFuncionario`),
  KEY `idSeguimiento` (`idSeguimiento`),
  KEY `respuesta_ibfk_3` (`idTipodoc`),
...
INSERT INTO `respuesta` VALUES (1,'2018-06-07 08:31:54','557','La superintendencia','asunto prueba',1,2,1,'sin redaccion de documento');
...
INSERT INTO `usuarios` VALUES (1,'','admin','123',1),(2,'user','user','123',1);
